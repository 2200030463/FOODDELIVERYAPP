        ...
        <Flex justifyContent={"space-between"}>
          ...
          <Box w={{ base: "100%", md: "100%", lg: "67%" }}>
            <Box
              ...
              <Flex direction={{ base: "column", md: "row", lg: "row" }}>
                <Box
                  ...
                  <Text fontSize={"15px"}> 5:45 pm</Text>
                </Box>
                <Box
                  border={"1px solid gray"}
                  ...
                  <Flex py={"5px"}>
                    ...
                    <Text pt={"5px"} px={"10px"}>
                      Only ₹{" "}
                      {(storedata?.act_price - storedata?.act_price * 0.01) /
                        2?.toLocaleString("en-US")}{" "}
                      Discount per person The remaining amount will be due on Mar
                      1st, 2024
                    </Text>
                  </Flex>
                  <Flex py={"5px"}>
                    ...
                    <Text px={"10px"}>
                      A few Tables left and yours is reserved for the  10th
                      table
                    </Text>
                  </Flex>
                  <Flex py={"5px"}>
                    ...
                    <Text px={"10px"}>
                      Instant Book: Your tables will be instantly secured.
                    </Text>
                  </Flex>
                  <Flex py={"5px"}>
                    <AiFillTag size={"22px"} />
            ...
            <Box
              ...
              <HStack mt={"30px"}>
                <Text fontWeight={"700"}>{traveller} x Customers</Text>
                <Spacer />
                <HStack>
                  <IconButton
            ...
            <Box
              ...
              <HStack>
                ...
                <Text px={"10px"} fontWeight={"700"} fontSize={"20px"}>
                  Add customer details for Feedback
                </Text>
              </HStack>
              <HStack
                ml={"8px"}
...
"Please ensure that the phone number and Email provided is correct and accurate."
                  </Text>
                </HStack>
              </HStack>
                  ...
                  <ModalContent w={"350px"} top={"22%"} py={"30px"}>
                    <ModalBody>
                      ...
                      <VStack>
                        ...
                        <Text fontSize={"15px"}>
                          Thank You for booking on Delicious Food.
                        </Text>
            ...
            <Box
              ...
              It appears that there might be some confusion in your message. It mentions Delicious Food as an authorized agent of Expat Explore Travel and emphasizes the importance of familiarizing yourself with Expat Explore Travel's payment, cancellation, and refund policies, as well as Delicious Food, Terms & Conditions. Additionally, there is a mention of currency and the absence of booking fees.
              </Text>
            </Box>
          </Box>
